...
export var IconWrapper = styled('div', function (props) {
  ...
  var $size = props.$size,
      $theme = props.$theme;
  var margin = (_margin = {}, _defineProperty(_margin, SIZE.compact, $theme.sizing.scale500), _defineProperty(_margin, SIZE.default, $theme.sizing.scale600), _defineProperty(_margin, SIZE.large, $theme.sizing.scale700), _margin);
