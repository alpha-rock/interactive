...
function Card(props) {
  ...
  var Title = getOverride(TitleOverride) || StyledTitle;
  var $hasThumbnail = hasThumbnail(props);
  return React.createElement(Root, _extends({
    "data-baseweb": "card"
  }, restProps, getOverrideProps(RootOverride)), headerImage && React.createElement(HeaderImage, _extends({
    src: headerImage
  }, getOverrideProps(HeaderImageOverride))), React.createElement(Contents, getOverrideProps(ContentsOverride), thumbnailSrc && React.createElement(Thumbnail, _extends({
    src: thumbnailSrc
