...
var StatefulListContainer =
/*#__PURE__*/
function (_React$Component) {
  _inherits(StatefulListContainer, _React$Component);

  function StatefulListContainer() {
    var _getPrototypeOf2;

    var _this;

    _classCallCheck(this, StatefulListContainer);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(StatefulListContainer)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onChange", function (_ref) {
      ...
      var newItemsState = newIndex === -1 ? arrayRemove(_this.state.items, oldIndex) : arrayMove(_this.state.items, oldIndex, newIndex);
