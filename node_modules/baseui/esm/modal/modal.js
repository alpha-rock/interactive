...
function (_React$Component) {
  ...
  _createClass(Modal, [{
    ...
    value: function renderModal() {
      ...
      var Backdrop = getOverride(BackdropOverride) || StyledBackdrop;
      var DialogContainer = getOverride(DialogContainerOverride) || StyledDialogContainer;
      var Dialog = getOverride(DialogOverride) || StyledDialog;
      var Close = getOverride(CloseOverride) || StyledClose;
      ...
      return React.createElement(LocaleContext.Consumer, null, function (locale) {
        return (// eslint-disable-next-line jsx-a11y/no-autofocus
          ...
          }, sharedProps, getOverrideProps(RootOverride)), React.createElement(Backdrop, _extends({
            onClick: _this3.onBackdropClick
          }, sharedProps, getOverrideProps(BackdropOverride))), React.createElement(DialogContainer, _extends({}, sharedProps, getOverrideProps(DialogContainerOverride)), React.createElement(Dialog, _extends({
            tabIndex: -1,
          ...
          }, sharedProps, getOverrideProps(DialogOverride)), children, closeable ? React.createElement(Close, _extends({
            "aria-label": locale.modal.close,
            onClick: _this3.onCloseClick
          }, sharedProps, getOverrideProps(CloseOverride)), React.createElement(CloseIcon, null)) : null))))
        );
      });
    }
  }, {
