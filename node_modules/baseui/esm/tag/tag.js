...
function (_React$Component) {
  ...
  function Tag() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleActionKeyDown", function (event) {
  ...
  _createClass(Tag, [{
    ...
    value: function render() {
      ...
      }, rootHandlers, sharedProps, rootProps), React.createElement(Text, textProps, children), closeable ? React.createElement(Action, _extends({
