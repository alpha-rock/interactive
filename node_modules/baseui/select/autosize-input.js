...
function (_React$Component) {
  ...
  function AutosizeInput() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "sizer", void 0);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {
      inputWidth: 5
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "sizerRef", function (el) {
      _this.sizer = el;
    });
  ...
  _createClass(AutosizeInput, [{
    ...
    value: function render() {
      ...
      return React.createElement(React.Fragment, null, React.createElement(Input, _extends({}, componentInputProps, {
        ref: inputRef
      }, inputProps)), React.createElement(_styledComponents.StyledInputSizer, {
