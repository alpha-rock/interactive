...
import { formatDate, getDay, getMonth, getDate, isSameDay, isDayInRange, isAfter } from './utils/index.js';
...
function (_React$Component) {
  ...
  function Day() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "dayElm", void 0);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onMouseLeave", function (event) {
      _this.setState({
        isHovered: false
      });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "isWeekend", function () {
      var weekday = getDay(_this.props.date);
      return weekday === 0 || weekday === 6;
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "isOutsideMonth", function () {
  ...
  _createClass(Day, [{
    ...
    value: function isPseudoSelected() {
      var _this$props5 = this.props,
          ...
          value = _this$props5.value; // fix flow by passing a specific arg type and remove 'Array.isArray(value)'
    ...
    value: function isPseudoHighlighted() {
      var _this$props6 = this.props,
          ...
          highlightedDate = _this$props6.highlightedDate; // fix flow by passing a specific arg type and remove 'Array.isArray(value)'
    ...
    value: function getSharedProps() {
      ...
      return {
        ...
        $selected: $selected,
        $startDate: Array.isArray(this.props.value) && this.props.range && $selected ? isSameDay(date, this.props.value[0]) : false,
        $outsideMonth: this.isOutsideMonth()
      };
    }
  }, {
    key: "getAriaLabel",
    value: function getAriaLabel(sharedProps) {
      var _this$props8 = this.props,
          date = _this$props8.date,
          locale = _this$props8.locale;
      return "".concat(sharedProps.$selected ? sharedProps.$range ? sharedProps.$startDate ? 'Selected start date.' : 'Selected end date.' : 'Selected.' : sharedProps.$disabled ? 'Not available.' : 'Choose', " ").concat(formatDate(date, 'EEEE, MMMM do yyyy', locale), ". ").concat(!sharedProps.$disabled ? "It's available." : '');
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return !peekNextMonth && sharedProps.$outsideMonth ? React.createElement(Day, null) : // eslint-disable-next-line jsx-a11y/mouse-events-have-key-events
