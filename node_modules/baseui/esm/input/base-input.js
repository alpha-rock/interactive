...
function (_React$Component) {
  ...
  _createClass(BaseInput, [{
    ...
    value: function renderMaskToggle() {
      ...
      var iconSize = (_SIZE$compact$SIZE$de = {}, _defineProperty(_SIZE$compact$SIZE$de, SIZE.compact, '16px'), _defineProperty(_SIZE$compact$SIZE$de, SIZE.default, '20px'), _defineProperty(_SIZE$compact$SIZE$de, SIZE.large, '24px'), _SIZE$compact$SIZE$de)[this.props.size];
