...
function (_React$Component) {
  ...
  function Popover() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "animateInTimer", void 0);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "animateOutTimer", void 0);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "animateOutCompleteTimer", void 0);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onMouseEnterTimer", void 0);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onMouseLeaveTimer", void 0);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "generatedId", '');

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "anchorRef", React.createRef());

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "popperRef", React.createRef());

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "arrowRef", React.createRef());

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", _this.getDefaultState(_this.props));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "animateOut", function () {
      if (!_this.props.isOpen) {
        _this.setState({
          isAnimating: true
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onAnchorClick", function (e) {
      if (_this.props.onClick) {
        _this.props.onClick(e);
      }
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onAnchorMouseEnter", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onAnchorMouseLeave", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onPopoverMouseEnter", function () {
      if (_this.onMouseLeaveTimer) {
        clearTimeout(_this.onMouseLeaveTimer);
      }
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onPopoverMouseLeave", function () {
      _this.triggerOnMouseLeaveWithDelay();
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onPopperUpdate", function (normalizedOffsets, data) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "triggerOnMouseLeave", function () {
      if (_this.props.onMouseLeave) {
        _this.props.onMouseLeave();
      }
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "triggerOnMouseEnter", function () {
      if (_this.props.onMouseEnter) {
        _this.props.onMouseEnter();
      }
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDocumentClick", function (evt) {
