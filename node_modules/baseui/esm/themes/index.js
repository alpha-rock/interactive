...
export var LightTheme = createTheme(lightThemePrimitives, {
  name: 'light-theme'
});
export { createTheme, LightThemeMove, lightThemePrimitives, darkThemePrimitives, DarkTheme, DarkThemeMove };
export * from './types';