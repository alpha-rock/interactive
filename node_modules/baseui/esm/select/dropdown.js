...
function (_React$Component) {
  ...
  function SelectDropdown() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getItemLabel", function (option) {
  ...
  _createClass(SelectDropdown, [{
    ...
    value: function render() {
      ...
      var _this$props3 = this.props,
          maxDropdownHeight = _this$props3.maxDropdownHeight,
          multi = _this$props3.multi,
          noResultsMsg = _this$props3.noResultsMsg,
      ...
      var _getOverrides7 = getOverrides(overrides.StatefulMenu, StatefulMenu),
          ...
          statefulMenuProps = _getOverrides8[1];
