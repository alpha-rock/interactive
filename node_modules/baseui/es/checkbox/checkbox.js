  ...
  _createClass(StatelessCheckbox, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          labelPlacement = _this$props2$labelPla === void 0 ? checkmarkType === STYLE_TYPE.toggle ? 'left' : 'right' : _this$props2$labelPla,
      ...
      return React.createElement(Root, _extends({
        ...
        $labelPlacement: labelPlacement
      }, sharedProps, mouseEvents, getOverrideProps(RootOverride)), (labelPlacement === 'top' || labelPlacement === 'left') && labelComp, checkmarkType === STYLE_TYPE.toggle ? React.createElement(ToggleTrack, _extends({}, sharedProps, getOverrideProps(ToggleTrackOverride)), React.createElement(Toggle, _extends({}, sharedProps, getOverrideProps(ToggleOverride)), React.createElement(ToggleInner, _extends({}, sharedProps, getOverrideProps(ToggleInnerOverride))))) : React.createElement(Checkmark, _extends({
        checked: checked
