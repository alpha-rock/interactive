...
function (_React$PureComponent) {
  ...
  function StatefulMenu() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(StatefulMenu).apply(this, arguments));
  }
  ...
  _createClass(StatefulMenu, [{
    ...
    value: function render() {
      ...
      return React.createElement(NestedMenuContext.Consumer, null, function (ctx) {
        return React.createElement(StatefulContainer, _extends({}, ctx, props), function (renderProps) {
          return React.createElement(Menu, _extends({}, renderProps, {
            overrides: overrides
          }));
        });
      });
