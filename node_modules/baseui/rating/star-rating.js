...
function (_React$Component) {
  ...
  function StarRating() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "selectItem", function (value) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updatePreview", function (previewIndex) {
      _this.setState({
        previewIndex: previewIndex
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderRatingContents", function () {
      ...
      var _loop = function _loop(x) {
        ratings.push(React.createElement(Star, _extends({
          ...
          onKeyDown: function onKeyDown(e) {
            if (e.keyCode === _utils.SPACE_KEY_CODE || e.keyCode === _utils.ENTER_KEY_CODE) {
              _this.selectItem(x);
            }
          },
          ...
          onBlur: function onBlur() {
            return _this.updatePreview(undefined);
          }
        }, starProps)));
      };
