...
function (_React$Component) {
  ...
  _createClass(FormControl, [{
    ...
    value: function render() {
      ...
      }, sharedProps, getOverrideProps(ControlContainerOverride)), children, (caption || error || positive) && React.createElement(Caption, _extends({}, sharedProps, getOverrideProps(CaptionOverride)), hint)));
    }
  }]);
