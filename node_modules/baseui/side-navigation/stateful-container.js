...
function (_React$Component) {
  ...
  function StatefulContainer() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onChange", function (params) {
      ...
      _this.internalSetState(_constants.STATE_CHANGE_TYPE.change, params.item);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "internalSetState", function (type, item) {
      var nextState = {};

      if (type === _constants.STATE_CHANGE_TYPE.change) {
        nextState = {
          activeItemId: item.itemId
        };
      }

      var newState = _this.props.stateReducer ? _this.props.stateReducer(type, nextState, _this.state) : nextState;
