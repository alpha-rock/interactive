...
*/
export function starSVG(fillColor, strokeColor) {
...
export function angryRatingSVG(fillColor) {
...
export function sadRatingSVG(fillColor) {
...
export function neutralRatingSVG(fillColor) {
...
export function happyRatingSVG(fillColor) {
...
export function veryHappyRatingSVG(fillColor) {
