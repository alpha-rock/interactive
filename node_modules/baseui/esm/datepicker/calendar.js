...
import { addDays, addMonths, getMonth, addWeeks, getEffectiveMinDate, getEffectiveMaxDate, isAfter, isBefore, isSameDay, isSameMonth, isSameYear, subDays, subWeeks, subMonths, subYears, setHours, setMinutes, setSeconds, getHours, getMinutes } from './utils/index.js';
...
function (_React$Component) {
  ...
  function Calendar(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "root", void 0);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "calendar", void 0);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getDateInView", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleMonthChange", function (date) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleYearChange", function (date) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "changeMonth", function (_ref) {
      var date = _ref.date;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "changeYear", function (_ref2) {
      var date = _ref2.date;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderCalendarHeader", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleArrowKey", function (key) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "blurCalendar", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleTabbing", function (event) {
      if (typeof document !== 'undefined') {
        if (event.keyCode === 9) {
          ...
          var focusable = _this.root ? _this.root.querySelectorAll('[tabindex="0"]') : null;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDayMouseOver", function (data) {
      var date = data.date;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDayMouseLeave", function (data) {
      var date = data.date;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleDateChange", function (data) {
      ...
      } else if (!Array.isArray(_this.props.value)) {
        if (data.date) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleTimeChange", function (time, index) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderTimeSelect", function (value, onChange) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderQuickSelect", function () {
      ...
      var _getOverrides15 = getOverrides(overrides.QuickSelect, Select),
          _getOverrides16 = _slicedToArray(_getOverrides15, 2),
          QuickSelect = _getOverrides16[0],
          quickSelectProps = _getOverrides16[1];
      ...
      return React.createElement(LocaleContext.Consumer, null, function (locale) {
        return React.createElement(QuickSelectContainer, quickSelectContainerProps, React.createElement(QuickSelectFormControl, _extends({
          ...
          options: _this.props.quickSelectOptions || QUICK_SELECT_ACTIONS,
          placeholder: "None",
  ...
  _createClass(Calendar, [{
    ...
    value: function render() {
      ...
      }, rootProps), this.renderMonths(), this.props.timeSelectStart && this.renderTimeSelect(startDate, function (time) {
        return _this2.handleTimeChange(time, 0);
      }), this.props.timeSelectEnd && this.props.range && this.renderTimeSelect(endDate, function (time) {
