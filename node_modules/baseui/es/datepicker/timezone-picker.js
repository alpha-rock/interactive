...
import { findTimeZone, getZonedTime, listTimeZones } from 'timezone-support/dist/index-2012-2022.js';
...
function (_React$Component) {
  ...
  function TimezonePicker() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "buildTimezones", function (compareDate) {
      ...
      .filter(function (option) {
        return option.label[0] !== '-' && option.label[0] !== '+';
