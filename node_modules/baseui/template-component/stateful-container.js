...
function (_React$Component) {
  ...
  function StatefulContainer() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(StatefulContainer)).call.apply(_getPrototypeOf2, [this].concat(_args)));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onClick", function () {
      ...
      _this.internalSetState('click', {
        prop: !_this.state.prop
      });
    });
  ...
  _createClass(StatefulContainer, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          restProps = _objectWithoutProperties(_this$props2, ["children", "initialState", "stateReducer"]);
