...
function (_React$Component) {
  ...
  function StatefulSliderContainer(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onChange", function (params) {
      _this.internalSetState(STATE_CHANGE_TYPE.change, params);

      return _this.props.onChange(_objectSpread({}, params));
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "internalSetState", function (type, _ref) {
