...
function (_React$Component) {
  ...
  function SideNav() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "activePredicate", function (item) {
  ...
  _createClass(SideNav, [{
    ...
    value: function render() {
      ...
      var renderNavItem = function renderNavItem(item, level, index, mapItem) {
        ...
        }, sharedProps, itemContainerProps), React.createElement(React.Fragment, null, React.createElement(_navItem.default, _extends({
          item: item,
