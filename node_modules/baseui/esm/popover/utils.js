...
export function getPopoverMarginStyles(showArrow, placement) {
  ...
  return _defineProperty({}, property, "".concat(showArrow ? ARROW_SIZE : POPOVER_MARGIN, "px"));
}
/**
 * Returns CSS rules for the popover animation start keyframe
 */

export function getStartPosition(offset, placement, showArrow) {
  ...
  var margin = (showArrow ? ARROW_SIZE : POPOVER_MARGIN) * 2;
