...
export var StyledClearIconContainer = styled('div', function (_ref) {
  var _ref2;
  ...
  }, _defineProperty(_ref2, $theme.direction === 'rtl' ? 'paddingLeft' : 'paddingRight', $theme.sizing.scale500), _defineProperty(_ref2, "paddingTop", $alignTop ? $theme.sizing.scale500 : '0px'), _defineProperty(_ref2, "color", $theme.colors.foregroundAlt), _ref2;
});
StyledClearIconContainer.displayName = "StyledClearIconContainer";
export var StyledClearIcon = styled(DeleteAlt, {
  cursor: 'pointer'
});
...
function getInputPadding(size, sizing) {
  ...
  return (_SIZE$compact$SIZE$de = {}, _defineProperty(_SIZE$compact$SIZE$de, SIZE.compact, {
    paddingTop: sizing.scale200,
    paddingBottom: sizing.scale200,
    paddingLeft: sizing.scale400,
    paddingRight: sizing.scale400
  }), _defineProperty(_SIZE$compact$SIZE$de, SIZE.default, {
    paddingTop: sizing.scale400,
    paddingBottom: sizing.scale400,
    paddingLeft: sizing.scale550,
    paddingRight: sizing.scale550
  }), _defineProperty(_SIZE$compact$SIZE$de, SIZE.large, {
    paddingTop: sizing.scale550,
    paddingBottom: sizing.scale550,
    paddingLeft: sizing.scale650,
    paddingRight: sizing.scale650
  }), _SIZE$compact$SIZE$de)[size];
}

function getFont(size, typography) {
  var _SIZE$compact$SIZE$de2;

  return (_SIZE$compact$SIZE$de2 = {}, _defineProperty(_SIZE$compact$SIZE$de2, SIZE.compact, typography.font300), _defineProperty(_SIZE$compact$SIZE$de2, SIZE.default, typography.font400), _defineProperty(_SIZE$compact$SIZE$de2, SIZE.large, typography.font460), _SIZE$compact$SIZE$de2)[size];
}
...
function getInputEnhancerPadding($size, sizing) {
  var _SIZE$compact$SIZE$de3;

  return (_SIZE$compact$SIZE$de3 = {}, _defineProperty(_SIZE$compact$SIZE$de3, SIZE.compact, {
    paddingRight: sizing.scale400,
    paddingLeft: sizing.scale400
  }), _defineProperty(_SIZE$compact$SIZE$de3, SIZE.default, {
    paddingRight: sizing.scale600,
    paddingLeft: sizing.scale600
  }), _defineProperty(_SIZE$compact$SIZE$de3, SIZE.large, {
    paddingRight: sizing.scale650,
    paddingLeft: sizing.scale650
  }), _SIZE$compact$SIZE$de3)[$size];
}
