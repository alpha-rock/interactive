...
function (_React$Component) {
  ...
  function StatefulContainer(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "changeState", function (nextState) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onClick", function (event, index) {
      ...
      if (_this.props.mode === MODE.checkbox) {
        if (!_this.state.selected.includes(index)) {
          _this.changeState({
            selected: _toConsumableArray(_this.state.selected).concat([index])
          });
        } else {
          _this.changeState({
  ...
  _createClass(StatefulContainer, [{
    ...
    value: function render() {
      ...
      return this.props.children(_objectSpread({}, props, {
