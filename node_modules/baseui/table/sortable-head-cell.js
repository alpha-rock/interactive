...
exports.default = SortableHeadCell;
...
function SortDirectionIcon(_ref) {
  ...
  switch (direction) {
    case _constants.SORT_DIRECTION.ASC:
      return React.createElement(_triangleDown.default, null);

    case _constants.SORT_DIRECTION.DESC:
      return React.createElement(_triangleUp.default, null);
...
function SortableHeadCell(props) {
  var _props$overrides = props.overrides,
      overrides = _props$overrides === void 0 ? {} : _props$overrides;

  var _getOverrides = (0, _overrides.getOverrides)(overrides.HeadCell, _styledComponents.StyledHeadCell),
  ...
  return React.createElement(HeadCell, _extends({
    role: "columnheader"
  }, headCellProps), React.createElement(SortableLabel, _extends({
