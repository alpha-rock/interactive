...
export default function PhoneInput(props) {
  var ariaLabel = props['aria-label'],
      ...
      size = props.size,
      text = props.text,
      restProps = _objectWithoutProperties(props, ["aria-label", "aria-labelledby", "aria-describedby", "country", "disabled", "error", "id", "mapIsoToLabel", "name", "onTextChange", "onCountryChange", "overrides", "placeholder", "positive", "size", "text"]);
