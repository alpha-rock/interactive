...
import { getOverrides } from '../helpers/overrides.js'; // value.length should not be bigger than two
...
var ThumbLabel = function ThumbLabel(_ref) {
  ...
  var _useThumbOverlap = useThumbOverlap(rangeRef, values, index),
...
function (_React$Component) {
  ...
  function Slider() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "rangeRef", React.createRef());
