...
import { StyledRoot, StyledControlContainer, StyledPlaceholder, StyledValueContainer, StyledInputContainer, StyledIconsContainer, StyledSelectArrow, StyledClearIcon, getLoadingIconStyles, StyledSearchIcon } from './styled-components.js';
import { shouldShowValue, shouldShowPlaceholder, expandValue } from './utils/index.js';
...
function (_React$Component) {
  ...
  _createClass(Select, [{
    ...
    value: function renderValue(valueArray, isOpen, locale) {
      ...
      var _getOverrides3 = getOverrides(overrides.Placeholder, StyledPlaceholder),
    ...
    value: function renderInput() {
      ...
      var _getOverrides5 = getOverrides(overrides.InputContainer, StyledInputContainer),
    ...
    value: function renderClear() {
      ...
      var _getOverrides7 = getOverrides(overrides.ClearIcon, DeleteAlt),
    ...
    value: function renderArrow() {
      ...
      var _getOverrides9 = getOverrides(overrides.SelectArrow, TriangleDownIcon),
    ...
    value: function renderSearch() {
      ...
      var sharedProps = this.getSharedProps();
      return React.createElement(StyledSearchIcon, _extends({}, sharedProps, searchIconProps), React.createElement(SearchIcon, {
        size: 16,
        title: 'search'
      }));
    }
    ...
    value: function render() {
      ...
      return React.createElement(LocaleContext.Consumer, null, function (locale) {
        ...
        }, sharedProps, controlContainerProps), type === TYPE.search ? _this6.renderSearch() : null, React.createElement(ValueContainer, _extends({}, sharedProps, valueContainerProps), _this6.renderValue(valueArray, isOpen, locale), _this6.renderInput()), React.createElement(IconsContainer, _extends({}, sharedProps, iconsContainerProps), _this6.renderLoading(), _this6.renderClear(), type === TYPE.select ? _this6.renderArrow() : null))));
      });
    }
  }]);
