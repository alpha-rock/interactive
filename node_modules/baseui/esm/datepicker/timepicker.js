...
function (_React$Component) {
  ...
  function TimePicker() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleChange", function (seconds) {
      var date = _this.props.value ? new Date(_this.props.value) : new Date();
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "buildSteps", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "creatableFilterOptions", function (options, filterValue, excludeOptions, newProps) {
