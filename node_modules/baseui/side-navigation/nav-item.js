...
function (_React$Component) {
  ...
  _createClass(NavItem, [{
    ...
    value: function render() {
      ...
      var _getOverrides = (0, _overrides.getOverrides)(overrides.NavItem, _styledComponents.StyledNavItem),
          _getOverrides2 = _slicedToArray(_getOverrides, 2),
          NavItem = _getOverrides2[0],
          itemProps = _getOverrides2[1];

      var _getOverrides3 = (0, _overrides.getOverrides)(overrides.NavLink, _styledComponents.StyledNavLink),
...
var _default = React.memo(NavItem, compare);
