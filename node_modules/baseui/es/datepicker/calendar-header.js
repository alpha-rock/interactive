...
import { StyledCalendarHeader, StyledPrevButton, StyledNextButton, StyledMonthHeader, StyledDay, StyledMonthYearSelectButton, StyledMonthYearSelectIconContainer } from './styled-components.js';
...
function (_React$Component) {
  ...
  function CalendarHeader() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleMonthChange", function (_ref2) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleYearChange", function (_ref3) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "increaseMonth", function () {
      if (_this.props.onMonthChange) {
        // $FlowFixMe
        _this.props.onMonthChange({
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "decreaseMonth", function () {
      if (_this.props.onMonthChange) {
        // $FlowFixMe
        _this.props.onMonthChange({
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "isMultiMonthHorizontal", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "isHiddenPaginationButton", function (direction) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderPreviousMonthButton", function (_ref4) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderNextMonthButton", function (_ref5) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "canArrowsOpenDropdown", function (event) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderMonthYearDropdown", function () {
  ...
  _createClass(CalendarHeader, [{
    ...
    value: function render() {
      ...
      var _getOverrides21 = getOverrides(overrides.WeekdayHeader, StyledDay),
