...
function Violation(props) {
  ...
  return React.createElement(Layer, null, React.createElement(TetherBehavior, {
    anchorRef: anchor,
    popperRef: popper,
  ...
  }, React.createElement(Caption1, null, props.target), props.violations.map(function (violation, index) {
    return React.createElement(Paragraph1, {
      key: index
