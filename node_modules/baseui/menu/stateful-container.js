...
function (_React$Component) {
  ...
  function MenuStatefulContainer() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", _objectSpread({}, _this.constructor.defaultProps.initialState, _this.props.initialState));

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "rootRef", React.createRef());

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "refList", []);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleArrowKey", function (event) {
      ...
      if (event.key === _constants.KEY_STRINGS.ArrowUp) {
        ...
        event.preventDefault();
        nextIndex = Math.min(prevIndex + 1, _this.props.items.length - 1);
      ...
      if (_this.refList[nextIndex]) {
        ...
        rootRef.current, nextIndex === 0, nextIndex === _this.props.items.length - 1);
      }
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleEnterKey", function (event) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleItemClick", function (activedescendantId, index, item, event) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleMouseEnter", function (activedescendantId, index) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getRequiredItemProps", function (item, index) {
      ...
      return _objectSpread({
        ...
        onClick: _this.handleItemClick.bind(_assertThisInitialized(_assertThisInitialized(_this)), activedescendantId, index, item),
        onMouseEnter: _this.handleMouseEnter.bind(_assertThisInitialized(_assertThisInitialized(_this)), activedescendantId, index),
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "focusMenu", function (event) {
      var rootRef = _this.props.rootRef ? _this.props.rootRef : _this.rootRef;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "unfocusMenu", function () {
      _this.internalSetState(_constants.STATE_CHANGE_TYPES.focus, {
        isFocused: false
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "resetMenu", function () {
  ...
  _createClass(MenuStatefulContainer, [{
    ...
    value: function componentDidMount() {
      ...
      if (typeof document !== 'undefined') {
        ...
        && this.state.highlightedIndex > -1 && this.refList[this.state.highlightedIndex]) {
          (0, _utils.scrollItemIntoView)(this.refList[this.state.highlightedIndex].current, rootRef.current, this.state.highlightedIndex === 0, this.state.highlightedIndex === this.props.items.length - 1);
        }
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          stateReducer = _this$props2.stateReducer,
          children = _this$props2.children,
          onItemSelect = _this$props2.onItemSelect,
          addMenuToNesting = _this$props2.addMenuToNesting,
          removeMenuFromNesting = _this$props2.removeMenuFromNesting,
          getParentMenu = _this$props2.getParentMenu,
          getChildMenu = _this$props2.getChildMenu,
          restProps = _objectWithoutProperties(_this$props2, ["initialState", "stateReducer", "children", "onItemSelect", "addMenuToNesting", "removeMenuFromNesting", "getParentMenu", "getChildMenu"]);
