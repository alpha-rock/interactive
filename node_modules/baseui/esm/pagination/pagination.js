...
function (_React$PureComponent) {
  ...
  function Pagination() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getMenuOptions", memoize(function (numPages) {
      var menuOptions = [];
  ...
  _createClass(Pagination, [{
    ...
    value: function render() {
      ...
      var _getOverrides3 = getOverrides(overrides.PrevButton, StyledBaseButton),
          _getOverrides4 = _slicedToArray(_getOverrides3, 2),
          PrevButton = _getOverrides4[0],
          prevButtonProps = _getOverrides4[1];

      var _getOverrides5 = getOverrides(overrides.NextButton, StyledBaseButton),
          _getOverrides6 = _slicedToArray(_getOverrides5, 2),
          NextButton = _getOverrides6[0],
          nextButtonProps = _getOverrides6[1];

      var _getOverrides7 = getOverrides(overrides.MaxLabel, StyledMaxLabel),
          _getOverrides8 = _slicedToArray(_getOverrides7, 2),
          MaxLabel = _getOverrides8[0],
          maxLabelProps = _getOverrides8[1];

      var _getOverrides9 = getOverrides(overrides.DropdownContainer, StyledDropdownContainer),
          _getOverrides10 = _slicedToArray(_getOverrides9, 2),
          DropdownContainer = _getOverrides10[0],
          dropdownContainerProps = _getOverrides10[1];

      var _getOverrides11 = getOverrides(overrides.Select, BaseSelect),
      ...
      return React.createElement(ThemeContext.Consumer, null, function (theme) {
        return React.createElement(LocaleContext.Consumer, null, function (locale) {
          ...
          }, rootProps), React.createElement(Button, _extends({
          ...
          }, maxLabelProps), "".concat(labels && labels.preposition ? labels.preposition : locale.pagination.preposition || '', " ").concat(numPages)), React.createElement(Button, _extends({
